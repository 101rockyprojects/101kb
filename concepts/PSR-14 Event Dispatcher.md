...
PSR-14 es un estandar de PHP-FIG para despachar eventos dentro de una aplicacion PHP. Define interfaces y conceptos para desacoplar emisores de listeners.

Referencia: https://www.php-fig.org/psr/psr-14/

## Definiciones (resumen)

- **Event** - An Event is a message produced by an _Emitter_. It may be any arbitrary PHP object.
...
- Cuando quieres publicar eventos internos sin acoplar el core a implementaciones concretas.
- Para side-effects: audit logs, emails, integraciones, etc.
